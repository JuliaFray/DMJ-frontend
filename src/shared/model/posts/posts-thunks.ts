...
export const getPopularTags = createAsyncThunk<TChipData[], unknown, { rejectValue: string }>(
  'posts/tags',
  async (__, thunkAPI) => {
...
export const getPopularAuthors = createAsyncThunk<TChipData[], unknown, { rejectValue: string }>(
  'posts/authors',
  async (__, thunkAPI) => {
