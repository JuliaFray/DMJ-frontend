...
export const getUserProfile = createAsyncThunk<IUser, { userId: string }, { rejectValue: string }>(
  'profile',
  async (data, thunkAPI) => {
    try {
...
export const createFriendProfile = createAsyncThunk<
  void,
...
export const toggleFriendProfile = createAsyncThunk<
  void,
