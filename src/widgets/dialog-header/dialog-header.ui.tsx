...
import styles from "pages/dialogs/dialog-page.module.scss";
...
export const DialogHeader: React.FC<IDialogHeader> = (props, context) => {
      ...
      >
        <div className={styles.dialogHeaderInfo}>
          ...
          <Avatar
            key={uuidv4()}
            alt={getFullName(to)}
            src={getImage(to.avatar, true)}
          />
          <Typography key={uuidv4()} className={styles.author} noWrap>
            {getFullName(to)}
          </Typography>
        </div>
