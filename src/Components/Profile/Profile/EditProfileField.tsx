    ...
    return (
        <>
            {props.editMode && props.type === 'string' &&
                <Input defaultValue={props.value} inputProps={{'aria-label': props.name}} placeholder={props.placeholder}/>}
            {props.editMode && props.type === 'date' &&
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="de"> <DatePicker/></LocalizationProvider>}
